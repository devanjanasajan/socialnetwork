...
<html>
<head>
    <title>Echomate-Sharing is Caring</title>
    ...
    <style>
        ...
        .content {
            ...
            box-shadow: 0 0 5px #bad35e;
        }
    </style>
</head>
<body>
    <h1><b>Welcome to EchoMate!</b></h1>
    <div class="container">
        <div class="tab">
        ...
        <div class="content">
            ...
            <div class="tabcontent" id="signup">
                <form method="post" onsubmit="return validateRegister()">
                    ...
                    <br><br>
                    <input type="submit" value="Let's Go!" name="register">
                </form>
            </div>
        </div>
    </div>
